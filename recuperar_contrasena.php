...
<head>
    ...
    <title>GEMO | Recuperar contraseña</title>
    ...
    <div class="login-wrap">
        <div class="login-card">
            ...
            <div class="text-center mb-4">
                ...
                <p class="text-muted mb-0">Ingrese el correo registrado en GEMO</p>
            </div>
            ...
            <form method="post" action="controllers/RecuperacionController.php">
                ...
                <a href="login.php" class="btn btn-outline-secondary btn-lg w-100 mt-2">
