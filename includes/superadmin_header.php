<?php require_once __DIR__ . '/superadmin_auth.php'; ?>
<!doctype html>
<html lang="es">
<head>
<meta charset="utf-8">
...
<li class="nav-item <?= basename($_SERVER['PHP_SELF'])==='acerca_de.php'?'active':'' ?>"><a href="acerca_de.php"><i class="fas fa-info-circle"></i><p>Acerca de GEMO</p></a></li><li class="nav-item <?= basename($_SERVER['PHP_SELF'])==='manual_usuario.php'?'active':'' ?>"><a href="manual_usuario.php"><i class="fas fa-video"></i><p>Manual de usuario</p></a></li>
