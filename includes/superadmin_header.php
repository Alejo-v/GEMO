...
<li class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'auditoria_terreno.php' ? 'active' : '' ?>">
<a href="auditoria_terreno.php">
<i class="fas fa-history"></i>
<p>Auditoría de terreno</p>
</a>
</li>
<li class="nav-item <?= basename($_SERVER['PHP_SELF']) === 'permisos.php' ? 'active' : '' ?>">
<a href="permisos.php">
